...
const Skills = () => {
  return (
    <div className="mt-24 rounded-4xl h-[1026px] z-50 w-full overflow-hidden  bg-white py-20 sm:mt-32 sm:py-32 lg:mt-56">
      <Container>
    ...
    <Image src={work} className=' z-[1000px] bg-white  w-full md:w-3/4 mx-auto rounded-4xl' alt='team' />
